...
// SendTransfer is a paid mutator transaction binding the contract method 0xfa500aab.
//
// Solidity: function sendTransfer(string denom, uint64 amount, string receiver, string sourcePort, string sourceChannel, uint64 timeoutHeight) returns()
func (_Ics20transferbank *Ics20transferbankTransactor) SendTransfer(opts *bind.TransactOpts, denom string, amount uint64, receiver string, sourcePort string, sourceChannel string, timeoutHeight uint64) (*types.Transaction, error) {
...
//
// Solidity: function sendTransfer(string denom, uint64 amount, string receiver, string sourcePort, string sourceChannel, uint64 timeoutHeight) returns()
func (_Ics20transferbank *Ics20transferbankSession) SendTransfer(denom string, amount uint64, receiver string, sourcePort string, sourceChannel string, timeoutHeight uint64) (*types.Transaction, error) {
...
//
// Solidity: function sendTransfer(string denom, uint64 amount, string receiver, string sourcePort, string sourceChannel, uint64 timeoutHeight) returns()
func (_Ics20transferbank *Ics20transferbankTransactorSession) SendTransfer(denom string, amount uint64, receiver string, sourcePort string, sourceChannel string, timeoutHeight uint64) (*types.Transaction, error) {
	return _Ics20transferbank.Contract.SendTransfer(&_Ics20transferbank.TransactOpts, denom, amount, receiver, sourcePort, sourceChannel, timeoutHeight)
}
